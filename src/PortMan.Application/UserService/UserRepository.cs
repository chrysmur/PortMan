...
public class UserRepository : IUserRepository
{
    ...
    public Task<User> CreateUserAsync(string username, string email, string password, string tenantId, CancellationToken token) => throw new NotImplementedException();
